...
export default function PrimaryActionCard() {
  return (
    <div className="rounded-2xl border border-zinc-800 bg-gradient-to-br from-zinc-900/80 to-zinc-950 p-6 space-y-5">
      <div>
        <p className="text-xs uppercase tracking-[0.2em] text-zinc-500">Creator launchpad</p>
        <h2 className="text-2xl font-semibold text-white mt-2">Create a post</h2>
        <p className="text-sm text-zinc-400 mt-2">
          Write once. Publish everywhere with one flow.
        </p>
      </div>

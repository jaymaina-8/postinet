/**
 * How it works: 3 steps — Connect accounts, Upload content, Schedule or post.
 * Outcome phrasing, one sentence per card.
 */
export function HowItWorks() {
  const steps = [
    {
      title: "Connect accounts",
      body: "Link your Facebook Page and YouTube channel in one place.",
      icon: (
    ...
    },
    {
      ...
      body: "Add your video or image once. No re-uploading per platform.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      body: "Pick a time or post now. We handle publishing for you.",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">

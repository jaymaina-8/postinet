  ...
  function getPlatformIcon(platform: Platform) {
    switch (platform) {
      ...
      case PLATFORMS.INSTAGRAM:
        return (
          <div className="w-12 h-12 rounded-xl bg-linear-to-br from-purple-600 via-pink-500 to-orange-400 flex items-center justify-center">
            <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <>
                          {expired && (
                            <button
                              ...
                              className="w-full sm:w-auto px-4 py-2 bg-emerald-500 text-zinc-950 text-sm font-semibold rounded-lg hover:bg-emerald-400 transition-colors disabled:opacity-50"
                            >
                          ...
                          <button
                            ...
                            disabled={actionLoading === platform}
                            className="w-full sm:w-auto px-4 py-2 border border-zinc-700 text-zinc-200 text-sm font-semibold rounded-lg hover:border-zinc-500 transition-colors disabled:opacity-50"
                          >
